...
const char* ssid     = "Partha_Ray";
const char* password = "bsnl@291622";
//chatgpt api
const char* chatgpt_token = "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";
...
//        Serial.println(payload);
      ...
      if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
        ...
        const char* text = doc["choices"][0]["text"]; // "choices" is an array
        chatgpt_A = String(text);
        Serial.print("ChatGPT Answer is: ");
        Serial.println(chatgpt_A);
        Serial.println("Wait 10s before next round...");
        currentState = do_webserver_index;
